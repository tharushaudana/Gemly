...
const ProductDetail = () => {
  ...
  const handleAddToCart = () => {
    addToCart(product, quantity, selectedMetalType, selectedSize);
    setAddedToCart(true);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            ...
            {/* Assuming product.availableSizes is an array */}
            {product.availableSizes.length > 0 && product.availableSizes[0] !== 'One Size' && (
              <div className="mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              <Button
                ...
                className={`flex items-center justify-center gap-2 ${
                  isProductInWishlist ? 'bg-[#800020] border-[#800020] hover:bg-[#6A001A]' : ''
                }`}
              >
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  <span className="font-medium text-gray-800">Collection:</span> {product.collection}
                </div>
              </div>
            </div>
          </div>
