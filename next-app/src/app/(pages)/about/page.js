          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                At LUXE, we believe that jewelry is more than an accessory—it's a tangible expression of life's most cherished moments...
              </p>
              <p className="text-gray-600 mb-4">
                We are committed to ethical sourcing, exceptional craftsmanship, and unparalleled customer service...
              </p>
              <p className="text-gray-600">
                Our team of master jewelers combines traditional techniques with innovative design...
              </p>
            </div>
            ...
            <div className="relative">
              <Image
                ...
                height={400}
              />
              <div className="absolute -bottom-6 -left-6 w-1/2 h-1/2 bg-[#D4AF37]/10 rounded-lg -z-10" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              These core principles guide everything we do at LUXE...
            </p>
          </div>
            ...
            {[
              {
                ...
                text: 'We use only the finest materials and employ rigorous quality control...'
              },
              {
                number: '02',
                title: 'Ethical Sourcing',
                text: 'We are committed to responsible sourcing practices...'
              },
              {
                number: '03',
                title: 'Timeless Design',
                text: 'We create pieces that transcend trends...'
              }
            ].map((value, i) => (
              <div key={i} className="bg-white p-8 rounded-lg shadow-sm">
                <div className="w-12 h-12 bg-[#D4AF37]/10 rounded-full flex items-center justify-center mb-4">
                  <span className="text-[#D4AF37] text-xl font-serif">{value.number}</span>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-white/90 mb-8">
              We're here to help! Our team of jewelry experts is ready to assist...
            </p>
            <Link href="/contact">
              <Button
                variant="primary"
